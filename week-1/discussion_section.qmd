...
Questions to ask:
What is question the figure is trying to answer?
violin plots show us data spread: where it is more wider is where there is more data
...
fracking_clean <- fracking |> 
  # clean column names ----
  janitor::clean_names() %>% #turn column names into snake case "_". Better readability of the column name
...
```
Colorado more evenly distributed
